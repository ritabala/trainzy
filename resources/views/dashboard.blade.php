        ...
        >
          ...
          <div class="mt-4 flex items-end justify-between">
            <div>
              ...
              <span class="text-sm font-medium">{{ __('dashboard.stats.views') }}</span>
            </div>
        ...
        >
          ...
          <div class="mt-4 flex items-end justify-between">
            <div>
              ...
              <span class="text-sm font-medium">{{ __('dashboard.stats.profit') }}</span>
            </div>
        ...
        >
          ...
          <div class="mt-4 flex items-end justify-between">
            <div>
              ...
              <span class="text-sm font-medium">{{ __('dashboard.stats.products') }}</span>
            </div>
        ...
        >
          ...
          <div class="mt-4 flex items-end justify-between">
            <div>
              ...
              <span class="text-sm font-medium">{{ __('dashboard.stats.users') }}</span>
            </div>
