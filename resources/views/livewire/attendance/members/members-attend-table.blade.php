    ...
    <div class="overflow-x-auto bg-white rounded-lg mt-6 shadow dark:bg-gray-800">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600 dark:text-white dark:bg-gray-800 dark:border-gray-700 dark:border">
            ...
            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700 text-sm dark:text-gray-300">
                        <td class="px-4 py-3">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    <a href="{{ route('attendance.members.show', $attendance->id) }}" class="group block">
                        ...
                        <td class="px-4 py-3 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex space-x-2">
                                <a href="{{ route('attendance.members.show', $attendance->id) }}" 
                                   class="text-gray-600 hover:text-indigo-600 dark:text-gray-300 dark:hover:text-indigo-400 relative group"
                                ...
                                @hasCachedPermission('edit_member_attendance')
                                ...
                                @hasCachedPermission('delete_member_attendance')
                                <button wire:click="handleDeleteMemberAttend({{ $attendance->id }})"
                ...
                @empty
                    <tr>
                        <td colspan="3" class="px-4 py-3 text-center text-gray-500 dark:text-gray-300">
