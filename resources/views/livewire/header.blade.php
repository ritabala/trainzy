<header
  class="
  sticky top-0 z-9 flex w-full border-gray-200 bg-white dark:border-gray-700/80 dark:bg-black lg:border-b"
>
  <div
    class="flex flex-grow items-center justify-between px-4 py-2  md:px-6 2xl:px-11"
  >
    <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
      <!-- Hamburger Toggle BTN -->
      <button
        class="z-9 block rounded-sm border border-stroke bg-white p-1.5 shadow-sm dark:border-strokedark dark:bg-boxdark lg:hidden"
      ...
      <!-- Hamburger Toggle BTN -->
      <a class="block flex-shrink-0 lg:hidden h-10 w-10" href="{{ route('dashboard.index') }}">
      ...
      >
        ...
        >
          ...
          <span class="h-10 w-10 rounded-full">
            <img src="{{ $profilePhotoPath }}" class="size-10 rounded-full object-cover" alt="User" />
          </span>
        ...
        >
          <ul
            class="flex flex-col gap-5 border-b border-stroke px-6 py-3 dark:border-strokedark"
          >
            <li>
