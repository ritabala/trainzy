            ...
            <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="mt-3 sm:mt-5">
                        <h3 class="text-xl font-semibold leading-6 text-gray-900 dark:text-gray-100 mb-4">{{ __('settings.currencies.edit') }}</h3>
                        <div>
                            <form wire:submit="save" class="space-y-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" wire:model.live="decimal_places" id="decimal_places" min="0" max="10" value="2" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:text-gray-100">
