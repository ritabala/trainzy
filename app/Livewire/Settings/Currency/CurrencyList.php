...
namespace App\Livewire\Settings\Currency;
...
class CurrencyList extends Component
{
    ...
    {
        $this->selectedCurrency = Currency::find($id);
    ...
    {
        $currencies = Currency::when($this->search, function($query) {
        ...
        return view('livewire.settings.currency.currency-list', [
