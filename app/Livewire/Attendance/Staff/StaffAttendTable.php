...
class StaffAttendTable extends Component
{
    ...
    protected $listeners = ['deleteStaffAttend'];
    ...
    public function handleDeleteStaffAttend($id)
    {
    ...
    public function deleteStaffAttend($data)
    {
        try {
    ...
    public function render()
    {
        ...
        return view('livewire.attendance.staff.staff-attend-table', [
    ...
    {
        return redirect()->route('attendance.staff.edit', $id);
    }
